...
import { APIData , Employee ,SlotData , Tags , Session , Request , CandicateSession , Profile , User , FileData , RequestData , OfferedSlots } from '../service/models/api.data.structure';
...
export class APIService {
 ...
 // using the url of the local host + url of the method that is created in the index
  ...
  viewEmployees():Observable<APIData>{
    return this.http.get<APIData>(this.apiUrl + 'user/viewEmployees')
    .catch(this.errorHandler);
  }

  addEmployee(employee:Employee):Observable<APIData>{
    return this.http.post<APIData>(this.apiUrl + 'user/addEmployee',employee)
    .catch(this.errorHandler);
  }

  updateEmployee(employee:Employee):Observable<APIData>{
    return this.http.post<APIData>(this.apiUrl + 'user/updateEmployee', employee)
    .catch(this.errorHandler);
  }

  deleteEmployee(employee: Employee):Observable<APIData>{
    return this.http.delete<APIData>(this.apiUrl + 'user/deleteEmployee/' + employee.email)
    .catch(this.errorHandler);
  }
